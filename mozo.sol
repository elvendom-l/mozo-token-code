...
contract MOZO is Owner, IBEP20 {
  ...
  constructor() public {
    _name = "Mozo Coin Ticker";
    _symbol = "MOZO";
    _decimals = 18;
    _totalSupply = 100000000000 * 10 ** 18;
    _balances[msg.sender] = _totalSupply;
    transactionFee = 5000 * 10 ** 18;
  ...
  */
  ...
  /**
  * @dev Returns the sender address
  */
  ...
  */
  function transfer(address recipient, uint256 amount) external returns (bool) {
    ...
    uint256 sendAmount = amount.sub(transactionFee);
    
    _transfer(_msgSender(), transactionPoolAddress, transactionFee);
  ...
  */
  function transferFrom(address sender, address recipient, uint256 amount) external returns (bool) {
    ...
    _transfer(sender, transactionPoolAddress, transactionFee);
  ...
  */
  function setTransactionFee(uint256 newTransactionFee) external isOwner returns (uint){
  ...
  */
  function setBurnAmount(uint256 newBurnAmount) external isOwner returns (uint256) {
  ...
  */
  function setTransactionPoolAddress(address newTransactionPoolAddress) external isOwner returns (address) {
  ...
  * @dev set burn.
  */
  function burn() external isOwner returns (bool) {
